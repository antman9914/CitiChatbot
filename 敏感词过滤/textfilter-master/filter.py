...
if __name__ == "__main__":
    ...
    print(gfw.filter("你这个傻逼"))
    print(gfw.filter("兴奋剂"))
    # file_object_read = open('keywords2.txt','r',encoding='UTF-8')
    # file_object_write = open('a.txt','w',encoding='UTF-8')
    # try:
    #     all_the_text = file_object_read.read()
    #     file_object_write.write(gfw.filter(all_the_text))
    # finally:
